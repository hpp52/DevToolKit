...
public class DoubleUtil implements Serializable {
     ...
     * @return 两个参数的差
     */
    public static double sub(Double beiJian, Double jianShu) {
        BigDecimal b1 = new BigDecimal(Double.toString(beiJian));
        BigDecimal b2 = new BigDecimal(Double.toString(jianShu));
    ...
    public static Double divide(Double dividend, Double divisor) {
        return divide1(dividend, divisor, DEF_DIV_SCALE);
    }
    
    public static Double divide(Double dividend, Double divisor,int scale) {
    	return divide1(dividend, divisor, scale);
    }
     ...
     * @return 两个参数的商
     */
    public static Double divide1(Double dividend, Double divisor, Integer scale) {
        if (scale < 0) {
